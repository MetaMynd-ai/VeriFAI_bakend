...
let Web3AuthGuard = class Web3AuthGuard extends (0, passport_1.AuthGuard)('web3') {
    constructor(authWeb3Options, reflector) {
        super();
    ...
    async canActivate(context) {
        ...
        if (this.authWeb3Options.passport == types_1.IAuth.IConfiguration.IPassportStrategy.REDIS) {
...
//# sourceMappingURL=web3.guard.js.map